...
User message
    ...
    │
    ├─ 6. Generate response via Google Gemini (streaming disabled)
    │
    ├─ 7. Save updated history to Redis (last 50 msgs, TTL: 7 days)
    │
    └─ 8. Update chat metadata (last_message, count, TTL: 30 days)
```
